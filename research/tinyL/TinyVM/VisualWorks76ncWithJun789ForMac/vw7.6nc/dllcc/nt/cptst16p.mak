...
# Makefile for 16-bit Pascal calling convention test suite DLL on Windows 95/3.1
...
FIRSTCPP =
RC = rc
CFLAGS_D_WDLL = /nologo /f- /G2 /Gc /Zp8 /W3 /Zi /ALw /Od /D "PASCAL"="_pascal" /D "UPNOTSUPPORTED" /D "_DEBUG" /D "OENOTSUPPORTED" /FR /GD /Fd"CPTST16P.PDB"  /D /D
