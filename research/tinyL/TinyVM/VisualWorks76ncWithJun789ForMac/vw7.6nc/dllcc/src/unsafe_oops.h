 ...
 * handled by ParcPlace technical support.
 * ======================================================================
...
typedef int _oopInt;
typedef int _oopSized;
typedef unsigned int _oopUInt;
#else
...
#define _numFixedFields(anOop) \
	(_oopIntVal(_objDataPtr(_objClass(anOop), _class)->format) & \
	 	_classFixedFieldsMask)

/* From: oop.h or nbfObjHeaderAccess.h */
